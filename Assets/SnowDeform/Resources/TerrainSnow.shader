...
Shader "SnowDays/TerrainSnow"
{
    ...
    Dependency "AddPassShader" = "Hidden/SnowDays/TerrainSnow Add Pass"
    Dependency "BaseMapShader" = "Hidden/SnowDays/TerrainSnow Base Pass"
